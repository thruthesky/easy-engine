...
describe('Rules Test', function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        it("Unauthenticated user can't read a task", function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, rules_unit_testing_1.assertFails)((0, firestore_1.getDoc)((0, firestore_1.doc)(unauthedDb, '/tasks/task1')))];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, rules_unit_testing_1.assertSucceeds)((0, firestore_1.getDoc)((0, firestore_1.doc)(unauthedDb, '/task/task1')))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
